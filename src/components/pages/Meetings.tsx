                                        ...
                                        <tr key={meeting.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="p-3 text-sm text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    >
                                                        <svg className="w-4 h-4 text-green-700 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                                                    </button>
                        ...
                        {filteredAndSortedMeetings.map(meeting => {
                            ...
                            return (
                                <MobileListItem
                                    ...
                                    rightContent={
                                        <span className={`px-2 py-1 text-xs font-medium uppercase tracking-wider rounded-lg ${getStatusClass(meeting.status || 'Planlandı')}`}>
                                            {meeting.status || 'Planlandı'}
                                        </span>
                                    }
                                    bottomContent={
                                        <div className="space-y-2 text-sm">
                                            ...
                                            <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                                                ...
                                                <span className={`px-2 py-1 text-xs font-medium uppercase tracking-wider rounded-lg ${getStatusClass(meeting.outcome)}`}>
                                                    {meeting.outcome}
                                                </span>
                                            </div>
                                            {meeting.next_action_notes && (
                                                <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                                                    <span className="text-gray-600 dark:text-gray-400">Sonraki Eylem:</span>
                                                    <span className="text-gray-900 dark:text-gray-100 font-medium text-right">{meeting.next_action_notes}</span>
                                                </div>
                                            )}
