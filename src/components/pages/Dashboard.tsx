    ...
    return (
      <div>
        ...
        <div className={widgetGridClass}>
          ...
          <div
            className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm animate-fadeIn`}
          >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <p
                            className={`text-sm font-medium ${task.completed ? 'line-through text-gray-500 dark:text-gray-400' : 'text-gray-900 dark:text-white'}`}
                          >
                            {task.title}
                          </p>
                        </div>
          ...
          <div
            className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm animate-fadeIn animate-delay-100`}
          >
              ...
              {upcomingActions.length > 0 ? (
                upcomingActions.map((gorusme) => {
                  const customer = customers.find(
                    (c) => c.id === gorusme.customerId && !c.isDeleted
                  );
                  return (
                    <MobileListItem
                      key={gorusme.id}
          ...
          {lowStockProducts.length > 0 && (
            <div
              className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm border-2 border-yellow-200 dark:border-yellow-800 animate-fadeIn animate-delay-200`}
            >
              <div className="flex items-center justify-between mb-3 md:mb-4">
                <h3 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                  <span>⚠️</span>
          ...
          <div
            className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm animate-fadeIn animate-delay-200`}
          >
            <h3 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3 md:mb-4 flex items-center gap-2">
              <span>📋</span>
              Bekleyen Siparişler
          ...
          <div
            className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm animate-fadeIn animate-delay-300`}
          >
            <h3 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3 md:mb-4 flex items-center gap-2">
              <span>🏆</span>
          ...
          <div
            className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm animate-fadeIn animate-delay-400`}
          >
            <h3 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3 md:mb-4 flex items-center gap-2">
              <span>🔥</span>
          ...
          <div
            className={`bg-white dark:bg-gray-800 ${widgetPadding} rounded-xl shadow-sm animate-fadeIn animate-delay-500`}
          >
            <h3 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3 md:mb-4 flex items-center gap-2">
              <span>🚚</span>
          ...
          {lowStockProducts.length > 0 && (
            <div
              className={`bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 ${widgetPadding} rounded-xl border-2 border-yellow-300 dark:border-yellow-700 shadow-sm animate-fadeIn animate-delay-600`}
            >
              ...
              <div className="mt-4 p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg border border-yellow-300 dark:border-yellow-700">
                <p className="text-sm text-yellow-800 dark:text-yellow-200 font-medium">
                  💡 <strong>{lowStockProducts.length} ürün</strong> minimum stok seviyesinde veya
                  altında. Stok yenilemeyi düşünün.
                </p>
              </div>
            </div>
          )}
