import { Order, Customer, Product, Quote, Meeting } from '../types';

/**
 * Export data to CSV format
 * @param {any[]} data - Array of objects to export
 * @param {string} filename - Name of the file
 * @param {string[] | null} headers - Optional custom headers
 */
export const exportToCSV = (data: any[], filename: string, headers: string[] | null = null) => {
 ...
 */
export const exportOrdersToCSV = (orders: Order[], customers: Customer[]) => {
 ...
 */
export const exportQuotesToCSV = (quotes: Quote[], customers: Customer[]) => {
 ...
 */
export const exportMeetingsToCSV = (meetings: Meeting[], customers: Customer[]) => {
